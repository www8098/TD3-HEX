...
# This is to be understood as a transition: Given `state0`, performing `ActionNoise`
...
# Memory 中维护 recent_observations and  recent_terminals
class SequentialMemory(Memory): 
    ...
    def sample(self, batch_size, batch_idxs=None):                                                      # 返回experience存储s0 s1 ActionNoise reward terminal， state为一串observation序列
    ...
    def sample_and_split(self, batch_size, batch_idxs=None):                                            # 拆分sample获得的experience， 分别写入buffer
        ...
        for e in experiences:
            ...
            terminal1_batch.append(0. if e.terminal1 else 1.)                                           # 0代表terminal为true， 为false时写入1
